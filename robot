...
@-webkit-keyframes blink {
  50% {
    background: -webkit-radial-gradient(circle, red 15%, transparent 40%), #cc5    background-size:75px 150px;
;
  }
}
@-moz-keyframes blink {
...
<img src="https://media.giphy.com/media/bitO8f8SwJHck/giphy.gif">
